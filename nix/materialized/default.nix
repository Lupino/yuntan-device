  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "HTTP".revision = (((hackage."HTTP")."4000.4.0").revisions).default;
        ...
        "hashtables".revision = (((hackage."hashtables")."1.3").revisions).default;
        ...
        "hedis".revision = (((hackage."hedis")."0.15.1").revisions).default;
        ...
        "bytestring-lexing".revision = (((hackage."bytestring-lexing")."0.5.0.8").revisions).default;
